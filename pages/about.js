       ...
       <div>
          ...
          <figure className="float-right"><Image src="/fazal.png" width={100} height={100} /></figure>
           <p>
              ...
              If you’ve made it this far, feel free to reach out to me <Link href="mailto:fazalchemmengath@gmail.com" className="font-medium">@fazalilahi</Link> :)
           </p>
          <div className="pt-5 flex items-center">
          <Link
             href="/portfolio"
             className="text-md font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-500 bg-gray-200 dark:bg-gray-700 rounded-md px-3 py-2">Resume</Link> &nbsp;&nbsp;&nbsp;
