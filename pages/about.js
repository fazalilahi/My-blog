...
const about = () => {
    return (
        <div>
           ...
           <Link href="/portfolio"><a className="text-xl font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-500">My Portfolio</a></Link> &nbsp;&nbsp;
